...
function createBookAvg($resultAvg, $isbn13) {

$queryAvg="SELECT AVG(rating) FROM bookRead WHERE isbn13=".$isbn13;
return $resultAvg = $mysqli->query($queryAvg);
