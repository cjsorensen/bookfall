...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_INACTIVE"			=> "Your account had not been activated. Check your emails / spam folder for account activation instructions",
...
//Miscellaneous
$lang = array_merge($lang,array(
	"CAPTCHA_FAIL"			=> "The captcha did not match. Please try again.",
	"CONFIRM"				=> "Confirm",
	"DENY"					=> "Deny",
	"SUCCESS"				=> "Success",
	"ERROR"					=> "Error",
...
//Success
$lang = array_merge($lang, array(
"SUCCESS_BOOK_RECORDED" => "Thank You! Your book has been entered."
