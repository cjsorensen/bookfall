...
class User 
{
	...
	function __construct($user,$display,$pass,$email,$firstName,$lastName,$grade,$lexile)
	{
		...
		$this->user_grade = sanitize($grade);
		$this->user_lexile = sanitize($lexile);
	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("sssssissii", $this->username, $this->displayname, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active,$this->user_firstName,$this->user_lastName,$this->user_grade,$this->user_lexile);
				$stmt->execute();
