...
<hr class='large-8 columns'>

";

//navigation here in the future?
...
echo "
<div class='large-8 columns panel' id='regbox'>
<form name='newLostPass' action='".$_SERVER['PHP_SELF']."' method='post'>
<p>Enter your email and password below and we'll send you an email to reset your login.</p>
<p>
...
<p>
<label>&nbsp;</label>
<input class='button' type='submit' value='Recover Password' class='submit' />
</p>
</form>
</div>
</div>
